            ...
            <div className="row">
              <div className="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
                <span className="heading-meta">highlights</span>
                    <h2 className="colorlib-heading animate-box">Education {'\uff06'} Work Experience</h2>
              </div>
            </div>
            <div className="row">
                    ...
                    <div className="timeline-entry-inner">
                      <div className="timeline-icon color-3">
                        ...
                        <div className="timeline-label">
                            <h2>Internship at Funpodium <span>Jun. ~ Aug. 2020</span></h2>
                            <p><span className="author-img" style={{backgroundImage: 'url(images/about.png)'}} /></p>
                        </div>
                    </div>
                  </article>
